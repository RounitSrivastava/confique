...
const App = () => {
    ...
    const fetchMyRegistrations = async (user) => {
        ...
        try {
            const res = await fetch(`${API_URL}/users/${user._id}/registered-events`, {
            ...
            if (res.ok) {
                ...
                console.error('Failed to fetch my registrations:', data.message);
            }
        } catch (error) {
    ...
    const handleRegisterEvent = async (eventId, eventTitle) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                // ... existing notification and other state updates
                setNotifications(prev => [
                    {
                        _id: Date.now().toString(),
                ...
                // Also update the global registration count
