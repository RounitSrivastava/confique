    ...
    new GoogleStrategy({
        ...
        try {
            ...
            if (currentUser) {
                ...
                const avatar = profile.photos && profile.photos.length > 0 ? profile.photos[0].value : 'https://placehold.co/40x40/cccccc/000000?text=A';

                if (!email) {
                    // Handle case where no email is provided by Google.
                    // This could be due to user privacy settings.
                ...
                const newUser = await User.create({
                    ...
                    email, // Use the safely accessed email
                    avatar, // Use the safely accessed avatar
